...
let s:colors = {
      ...
      \ "diff_red": get(s:overrides, "diff_red", { "gui": "#2c1517", "cterm": "204", "cterm16": "1" }),
      \ "green": get(s:overrides, "green", { "gui": "#98C379", "cterm": "114", "cterm16": "2" }),
      \ "diff_green": get(s:overrides, "diff_green", { "gui": "#1e2718", "cterm": "114", "cterm16": "2" }),
      \ "yellow": get(s:overrides, "yellow", { "gui": "#E5C07B", "cterm": "180", "cterm16": "3" }),
      \ "diff_yellow": get(s:overrides, "diff_yellow", { "gui": "#3e2e1e", "cterm": "180", "cterm16": "3" }),
      ...
      \ "black": get(s:overrides, "black", { "gui": "#1f1f1f", "cterm": "235", "cterm16": "0" }),
      \ "dimm_black": get(s:overrides, "black", { "gui": "#1c1c1c", "cterm": "235", "cterm16": "0" }),
      \ "dark_black": get(s:overrides, "dark_black", { "gui": "#1a1a1a", "cterm": "235", "cterm16": "0" }),
      ...
      \ "vertsplit": get(s:overrides, "vertsplit", { "gui": "#252525", "cterm": "59", "cterm16": "15" }),
      \}
